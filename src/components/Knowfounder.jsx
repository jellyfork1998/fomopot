 ...
 <img className="kyfposition reveal fade-right" src={kf}/>
  <div className="row rowkyf">
    ...
    {/* <img className="image-cropper" src={founder} alt="Photo of sunset"/> */}
        ...
        <p className="card-text mt-5">"The utilities that have been planned include our own staking platform, NFT and NFT minting website, our own launchpad, last but not the least we will have our own NFT Marketplace.
We will build more utilities in the near future as we grow but it will not deviate us from our main utility which is 'Community satisfaction and profit making utility"</p> 
  </div>
    </div>
    </div>
